...
class MainWindow:
    def __init__(self, master):
        ...
        self.DisplayButton = tk.Button(master, text="Open Webcam", width=30, height=5,)
...
class Adjust:
    def __init__(self, root):
        ...
        self.FirstLabel.grid(row=0, column=0, columnspan=4, padx=10, pady=10, sticky=tk.W)

        self.LeftIncreaseY = tk.Button(root, text="UP", width=8, height=2)
        self.LeftIncreaseY.grid(row=1, column=0)
        ...
        self.LeftDecreaseX.grid(row=1, column=3)

        self.SecondLabel = tk.Label(root, text="Bottom Right Corner:")
        self.SecondLabel.grid(row=2, column=0, columnspan=4, padx=10, pady=10, sticky=tk.W)

        self.RightIncreaseY = tk.Button(root, text="UP", width=8, height=2)
        self.RightIncreaseY.grid(row=3, column=0)
        ...
        self.RightDecreaseX.grid(row=3, column=3)

        self.HelpButton = tk.Button(root, text="Help", width=8, height=2)
        self.HelpButton.grid(row=4, column=2)
        self.BackButton = tk.Button(root, text="Back", width=8, height=2)
        self.BackButton.grid(row=4, column=3)
